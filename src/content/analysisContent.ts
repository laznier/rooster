...
export const analysisSections: AnalysisSection[] = [
  ...
  // ── References ─────────────────────────────
  {
    ...
    content: [
      ...
      'Project Manager Helper. (2026). Competitive Position Analysis (CPA) tool [Web application]. https://www.projectmanagerhelper.com/cpa/',
      'Project Manager Helper. (2026). Risk Register & Mitigation tool [Web application]. https://www.projectmanagerhelper.com/risk-register/',
    ],
  },
];
