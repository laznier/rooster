...
// Edit this file to update your professional bio
// ─────────────────────────────────────────────

export const aboutContent = {
  heading: 'About Me',
  subheading: 'Strategic Leader · Military Officer · Analytical Thinker',
  ...
  competencies: [
    {
      area: 'Strategic Analysis & Frameworks',
      details:
        'Proficient in applying PESTEL, Porter\'s Five Forces, SWOT, value chain analysis, generic strategies, and competitive positioning frameworks to complex business situations.',
    },
    {
      area: 'Leadership & Organizational Management',
      details:
        'Proven leadership across diverse teams and operational environments, with experience aligning organizational structure, resources, and culture to strategic objectives.',
    },
    {
      area: 'Systems Thinking & Decision-Making',
      details:
        'Trained to evaluate interconnected systems, assess second- and third-order effects, and make informed decisions under ambiguity and time pressure.',
    },
    {
      area: 'Ethics, Sustainability & Global Awareness',
      details:
        'Committed to ethical reasoning, sustainability principles, and awareness of global competitive dynamics in strategic planning and recommendation development.',
    },
    {
      area: 'Technology & Digital Communication',
      details:
        'Capable of building practical digital tools and professional presentations that enhance analysis, stakeholder communication, and evidence-based reporting.',
    },
  ],
